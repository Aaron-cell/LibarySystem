                        ...
                        <ul class="nav navbar-nav navbar-right navlist">
                            ...
                            <li class="dropdown margin-left-20">
                            		<c:if test="${sessionScope.person==null }">
		                                <a class=" link "  href="fore/PopularBooks/login"​ title="登录" class="link  active">
		                                    登&nbsp;&nbsp;&nbsp;&nbsp;录
		                                </a>
	                               </c:if>
	                               <c:if test="${sessionScope.person!=null }">
                ...
                <ul class="blocks-100 blocks-sm-2 blocks-md-4 blocks-xlg-4 " data-scale=''>
                    <c:forEach items="${books1 }" var="books">
                       ...
                       <div style="text-align:center">
					        <a href="fore/PopularBooks?start=0"><span style="color:blue ;font-size:20px">首  页</span></a>
					        <c:if test="${page.start>0 }">
					        	<a href="fore/PopularBooks?start=${page.start-page.count}"><span style="color:blue ;font-size:20px">上一页</span></a>
					        </c:if>
					        ...
					        <a href="fore/PopularBooks?start=${page.start+page.count}"><span style="color:blue ;font-size:20px">下一页</span></a>
					        <a href="fore/PopularBooks?start=${page.last}"><span style="color:blue ;font-size:20px">末  页</span></a>
